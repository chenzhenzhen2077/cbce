    ...
    <div className="bg-surface-card border border-border rounded-xl overflow-hidden">
      ...
      <div className="p-5 space-y-5">
        ...
        <div className="text-xs text-text-muted leading-relaxed space-y-1">
          <p>📌 <strong>以上为参考框架，基于公开法定费率的区间估算。包含：</strong>公证费、登记税、司法书士/律师费、海牙认证费。不包含日本继承税（相続税）——继承税金额因继承人身份和资产分配而异，建议咨询日本税理士。</p>
          <p>📌 <strong>被继承人能做的是：</strong>① 保留足够现金覆盖继承费用（不要让资产全部锁在房产里）；② 提前立好分立遗嘱减少跨境程序费用；③ 将不同资产合理分配到不同继承人名下降低整体税负。</p>
          <p>📌 <strong>免责声明：</strong>本工具不提供税务意见。所有数字为参考区间，实际费用请咨询持牌税理士/税务师。</p>
        </div>
      </div>
